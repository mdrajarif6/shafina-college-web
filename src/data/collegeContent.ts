export interface CollegeTranslation {
  // Navigation
  navHome: string;
  navAbout: string;
  navPrograms: string;
  ...
  collegeName: string;
  collegeNameShort: string;
  collegeSubtitle: string;
  eiin: string;
  collegeCodeHsc: string;
  collegeCodeDegree: string;
  established: string;
  location: string;
  type: string;
  affiliation: string;
  ...
  presidentSpeech: string;
  presidentDegree: string;

  // Founder Section
  founderTitle: string;
  founderName: string;
  founderSpeech: string;
  founderVisionTitle: string;
  founderVisionText: string;
  ...
  honoursSection: string;
  hscDetails: string;
  degreeDetails: string;
  honoursDetails: string;
  ...
  resultExamLabel: string;
  resultRegLabel: string;
  resultRollLabel: string;
  resultYearLabel: string;
  resultSearchBtn: string;
  resultNotFound: string;
}

export const contentEN: CollegeTranslation = {
  navHome: "Home",
  navAbout: "About Us",
  navPrograms: "Academic Programs",
  navAdmission: "Admission Portal",
  navNotices: "Notice Board",
  navCampusMap: "Virtual Campus Map",
  navGallery: "Photo Gallery",
  navContact: "Contact Us",
  languageLabel: "বাংলা",

  collegeName: "Haji Jamir Uddin Shafina Women's Degree College",
  collegeNameShort: "HJS Women's College",
  collegeSubtitle: "Empowering Women through Quality Education, Moral Integrity, and Academic Leadership",
  eiin: "127037",
  collegeCodeHsc: "1029",
  collegeCodeDegree: "2567",
  established: "1995",
  location: "Luxmipur Vatapara, P.O. Rajshahi GPO-6000, Rajpara, Rajshahi, Bangladesh",
  type: "Non-Government Women's Degree College",
  affiliation: "Affiliated with Board of Intermediate & Secondary Education, Rajshahi & National University of Bangladesh",

  slogan1: "Nurturing modern skills with traditional moral values for women empowerment.",
  slogan2: "Building the leaders of tomorrow: Independent, creative, and patriotic citizens.",

  statStudents: "1,500+ Active Students",
  statTeachers: "45+ Faculty Members",
  statPassRate: "96.5% HSC Success Rate",
  statLabs: "5 Modern Labs",
  statCampusArea: "Well Decorated Safe Campus",

  principalTitle: "Message from Principal (In Charge)",
  principalName: "MD. Anamul Hoque Mondol",
  principalDegree: "Principal (In Charge)",
  principalSpeech: "Located in the western part of Rajshahi city, a clean and peaceful city of education on the banks of the river Padma, Haji Jamir Uddin Shafina Women's Degree College has been playing a pioneering role in the spread of women's education. Education enlightens the human mind and awakens a sense of justice. A modern education system, keeping pace with the changing world, properly develops the creativity of students. We have taken on the crucial responsibility of publishing a lesson plan and academic calendar to systematically prepare our students for their final exams. Discipline is life. Through the practice of discipline, human life flourishes beautifully. We are determined to build ourselves and our beloved motherland. My sincere congratulations and gratitude to everyone who worked tirelessly to make this publication possible.",

  presidentTitle: "Message from the President of the Governing Body",
  presidentName: "Shahanur Islam",
  presidentDegree: "President",
  presidentSpeech: "Education is the best tool to build a better future. The purpose of education is not only to earn money, but to establish humanity by keeping the human mind healthy, beautiful and strong. So we have to emphasize on human education. Haji Jamir Uddin Shafina Women's College is committed to making girls physically, mentally and intellectually fit. We are working towards this goal.",

  founderTitle: "Founder's Visionary Message",
  founderName: "Haji Jamir Uddin & Alhaj Shafina Begum",
  founderSpeech: "We envisioned an institution in Rajpara, Rajshahi, that would unlock opportunities for young women. Education is the greatest tool for social mobility, and when you educate a woman, you educate an entire nation.",
  founderVisionTitle: "Our Ultimate Mission",
  founderVisionText: "To realize the physical, intellectual, and moral growth of female students through a structured, updated curriculum and supportive extra-curricular activities, making them competent, empathetic, and independent citizens who can lead in diverse spheres of life.",

  academicTitle: "Our Academic Disciplines",
  academicSubtitle: "Explore the pathways of learning at Haji Jamir Uddin Shafina Women's Degree College, designed to equip you for bright futures.",
  hscSection: "Higher Secondary Certificate (HSC) Level",
  degreeSection: "Degree Pass Course (National University)",
  honoursSection: "Honours Programs (National University)",
  hscDetails: "Approved by Rajshahi Education Board. Offered in Science, Humanities, and Business Studies groups with dedicated digital classes.",
  degreeDetails: "3-Year Degree Pass Program (BA, BSS, BBS). Features tailored guidance and modern exam preparation standards.",
  honoursDetails: "4-Year Specialized Honours courses affiliated with NU. Offered in major subjects like Bangla, Social Work, Economics, and Management.",

  applyNowBtn: "Apply Online",
  checkEligibility: "Eligibility Calculator",
  latestNotices: "Latest Notice Feed",
  viewDetails: "View Details",
  closeBtn: "Close",

  resultSectionTitle: "Exam Results",
  resultSectionSubtitle: "Check your academic results easily using the National University portal integration.",
  resultExamLabel: "Examination",
  resultRegLabel: "Registration No",
  resultRollLabel: "Roll No",
  resultYearLabel: "Passing Year",
  resultSearchBtn: "Search Result",
  resultNotFound: "Result not found or API unavailable.",
};

export const contentBN: CollegeTranslation = {
  navHome: "হোম",
  navAbout: "আমাদের কথা",
  navPrograms: "একাডেমিক প্রোগ্রাম",
  navAdmission: "ভর্তি পোর্টাল",
  navNotices: "নোটিশ বোর্ড",
  navCampusMap: "ভার্চুয়াল ক্যাম্পাস ম্যাপ",
  navGallery: "ফটো গ্যালারি",
  navContact: "যোগাযোগ",
  languageLabel: "English",

  collegeName: "হাজী জমির উদ্দীন শাফিনা মহিলা ডিগ্রী কলেজ",
  collegeNameShort: "হাজী জমির উদ্দীন শাফিনা মহিলা কলেজ",
  collegeSubtitle: "মানসম্মত শিক্ষা, নৈতিক সততা এবং একাডেমিক নেতৃত্বের মাধ্যমে নারী ক্ষমতায়ন",
  eiin: "১২৭০৩৭",
  collegeCodeHsc: "১০২৯",
  collegeCodeDegree: "২৫৬৭",
  established: "১৯৯৫",
  location: "লক্ষ্মীপুর ভাটাপাড়া, ডাকঘর: রাজশাহী জিপিও-৬০০০, রাজপাড়া, রাজশাহী, বাংলাদেশ",
  type: "বেসরকারি মহিলা ডিগ্রি কলেজ",
  affiliation: "মাধ্যমিক ও উচ্চ মাধ্যমিক শিক্ষা বোর্ড, রাজশাহী এবং বাংলাদেশ জাতীয় বিশ্ববিদ্যালয় অধিভুক্ত",

  slogan1: "নারী ক্ষমতায়নের লক্ষ্যে ঐতিহ্যগত নৈতিক মূল্যবোধের সাথে আধুনিক দক্ষতার সমন্বয় সাধন।",
  slogan2: "আগামীর নেতৃত্ব গড়ে তোলা: স্বাবলম্বী, সৃজনশীল এবং দেশপ্রেমিক নাগরিক তৈরি।",

  statStudents: "১,৫০০+ নিয়মিত ছাত্রী",
  statTeachers: "৪৫+ অভিজ্ঞ শিক্ষক মণ্ডলী",
  statPassRate: "৯৬.৫% এইচএসসি পাশের হার",
  statLabs: "৫টি আধুনিক ল্যাব",
  statCampusArea: "সুসজ্জিত ও নিরাপদ ক্যাম্পাস",

  principalTitle: "অধ্যক্ষ (ভারপ্রাপ্ত) মহোদয়ের বাণী",
  principalName: "মোঃ এনামুল হক মন্ডল",
  principalDegree: "ভারপ্রাপ্ত অধ্যক্ষ",
  principalSpeech: "পদ্মা নদীর অববাহিকায় হযরত শাহ মখদুম রুপোশ (রঃ) এর পূণ্যভূমি পরিচ্ছন্ন ও শান্তির শহর, সবুজ নগরী ও শিক্ষা নগরী রাজশাহী বিভাগীয় শহরের পশ্চিমাঞ্চলে অবস্থিত নারী শিক্ষা বিস্তারে অগ্রণী ভূমিকা রেখেছে যে বিদ্যাপীঠ সেটি হচ্ছে বেসরকারী উদ্দ্যোগে প্রতিষ্ঠিত হাজী জমির উদ্দীন শাফিনা মহিলা ডিগ্রী কলেজ, রাজশাহী। নারীরা শিক্ষা-দীক্ষায় পিছিয়ে থাকতে পারে না। শিক্ষা মানুষের মনকে আলোকিত করে এবং ন্যায়-অন্যায় বোধকে জাগ্রত করে। পরিবর্তনশীল বিশ্বের সাথে তাল মিলিয়ে প্রণীত যুগোপযোগী শিক্ষা ব্যবস্থা শিক্ষার্থীদের সৃষ্টিশীলতায় যথাযথ বিকাশ ঘটায়। পাঠ পরিকল্পনা ও একাডেমিক ক্যালেন্ডার শিক্ষার্থীদের জন্য অপরিহার্য। কারণ, প্রতিষ্ঠানের সার্বিক চিত্র শিক্ষার্থীদের অন্তরে প্রথিত না থাকলে সেই প্রতিষ্ঠানের প্রতি তাদের মমত্ববোধ ও শ্রদ্ধাবোধের ঘাটতি থেকেই যায়। এজন্য কলেজ থেকে পাঠ পরিকল্পনা ও একাডেমিক ক্যালেন্ডার প্রকাশের মতো গুরু দায়িত্ব কাঁধে নিয়েছে। কলেজের অভ্যন্তরীণ কোন পরীক্ষা কখন অনুষ্ঠিত হবে এবং তার জন্য কোন কোন অধ্যায় পড়তে হবে। এভাবে পর্যায়ক্রমে তারা চূড়ান্ত পরীক্ষার জন্য প্রস্তুতি গ্রহনে সক্ষম হবে। এছাড়া শিক্ষক মন্ডলি ও সংশ্লিষ্ট সকলেই উপকৃত হবেন ইনশাল্লাহ্। শৃঙ্খলাই জীবন। শৃঙ্খলা চর্চার কারণে মানব জীবন সুন্দরভাবে বিকশিত হয়। নিজেদের এবং আমাদের প্রিয় মাতৃভূমি বিনির্মানে আমরা বদ্ধ পরিকর। সোনালী স্বপ্ন এবং অপার সম্ভাবনার প্রেক্ষাপটে এগিয়ে যাওয়ার এমন অভিযাত্রায় নারীদের পিছিয়ে থাকলে চলবে না। তাই নারী শিক্ষায় আগ্রণী ভূমিকা রাখাই এ কলেজের লক্ষ্য। যাঁরা অক্লান্ত পরিশ্রম করে এ প্রকাশনায় সহযোগিতা করেছেন তাদের সকলকে জানাই আমার আন্তরিক অভিনন্দন ও কৃতজ্ঞতা।",

  presidentTitle: "গভর্নিং বডির সভাপতির বাণী",
  presidentName: "শাহানুর ইসলাম",
  presidentDegree: "সভাপতি",
  presidentSpeech: "সুন্দর ভবিষ্যৎ গড়ার শ্রেষ্ঠ হাতিয়ার হলো শিক্ষা। শিক্ষার উদ্দেশ্য শুধু অর্থ উপার্জন নয়, বরং সুস্থ, সুন্দর ও সবল মননশীল মানুষ তৈরি করে মানবিকতার প্রতিষ্ঠা করা। তাই আমাদের মানবিক শিক্ষার উপর জোর দিতে হবে। হাজী জমির উদ্দীন শাফিনা মহিলা কলেজ মেয়েদেরকে শারীরিকভাবে, মানসিকভাবে ও মেধাভিত্তিক যোগ্য করে তুলতে প্রতিশ্রুতিবদ্ধ। আমরা এই লক্ষ্যেই কাজ করে যাচ্ছি।",

  founderTitle: "প্রতিষ্ঠাতার দূরদর্শী বাণী",
  founderName: "হাজী জমির উদ্দীন ও আলহাজ্ব শাফিনা বেগম",
  founderSpeech: "আমরা রাজশাহীর রাজপাড়ায় এমন একটি শিক্ষাপ্রতিষ্ঠানের স্বপ্ন দেখেছিলাম যা তরুণীদের জন্য সম্ভাবনার দ্বার উন্মুক্ত করবে। শিক্ষা হলো সামাজিক উন্নয়নের সবচেয়ে বড় হাতিয়ার, এবং আপনি যখন একজন নারীকে শিক্ষিত করবেন, তখন আপনি পুরো জাতিকে শিক্ষিত করবেন।",
  founderVisionTitle: "আমাদের সুনির্দিষ্ট লক্ষ্য ও উদ্দেশ্য",
  founderVisionText: "সুপরিকল্পিত পাঠ্যক্রম, সহ-পাঠ্যক্রম কর্মসূচির যথাযথ বাস্তবায়নের মাধ্যমে ছাত্রীদের শারীরিক ও মানসিক গুণাবলীর সর্বোচ্চ উৎকর্ষ সাধন যাতে তারা সুনাগরিক হিসেবে গড়ে উঠতে পারে এবং ভবিষ্যতে দেশ ও জাতিকে উপযুক্ত নেতৃত্ব দিতে পারে।",

  academicTitle: "আমাদের শিক্ষা কার্যক্রমসমূহ",
  academicSubtitle: "হাজী জমির উদ্দীন শাফিনা মহিলা ডিগ্রী কলেজের বিভিন্ন কোর্স এবং উজ্জ্বল ক্যারিয়ার গড়ার সঠিক দিকনির্দেশনা অন্বেষণ করুন।",
  hscSection: "উচ্চ মাধ্যমিক (এইচএসসি) স্তর",
  degreeSection: "ডিগ্রী পাস কোর্স (জাতীয় বিশ্ববিদ্যালয়)",
  honoursSection: "অনার্স কোর্সসমূহ (জাতীয় বিশ্ববিদ্যালয়)",
  hscDetails: "রাজশাহী শিক্ষা বোর্ড অনুমোদিত। বিজ্ঞান, মানবিক ও ব্যবসায় শিক্ষা শাখায় আধুনিক মাল্টিমিডিয়া শ্রেণীকক্ষ ও অভিজ্ঞ শিক্ষকমন্ডলী দ্বারা পরিচালিত।",
  degreeDetails: "৩ বছর মেয়াদী ডিগ্রী পাস কোর্স (বিএ, বিএসএস, বিবিএস)। ছাত্রীদের মানসম্মত ডিগ্রি অর্জনে নিবিড় ক্লাসরুম প্রশিক্ষণ।",
  honoursDetails: "জাতীয় বিশ্ববিদ্যালয়ের অধীনে ৪ বছর মেয়াদী প্রফেশনাল অনার্স কোর্স। বাংলা, সমাজকর্ম, অর্থনীতি এবং ব্যবস্থাপনা বিষয়ে স্পেশাল কেয়ার ক্লাস।",

  applyNowBtn: "অনলাইনে আবেদন করুন",
  checkEligibility: "ভর্তির যোগ্যতা যাচাই",
  latestNotices: "সর্বশেষ নোটিশ সমূহ",
  viewDetails: "বিস্তারিত দেখুন",
  closeBtn: "বন্ধ করুন",

  resultSectionTitle: "পরীক্ষার ফলাফল",
  resultSectionSubtitle: "জাতীয় বিশ্ববিদ্যালয়ের পোর্টাল ইন্টিগ্রেশন ব্যবহার করে সহজেই আপনার একাডেমিক ফলাফল চেক করুন।",
  resultExamLabel: "পরীক্ষার নাম",
  resultRegLabel: "রেজিস্ট্রেশন নম্বর",
  resultRollLabel: "রোল নম্বর",
  resultYearLabel: "পাসের সন",
  resultSearchBtn: "ফলাফল খুঁজুন",
...
// Campus layout mapping for the Interactive Map
